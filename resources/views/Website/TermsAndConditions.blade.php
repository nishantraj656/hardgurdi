<!DOCTYPE html>
    ...
    <h2>Terms &amp; Conditions</h2> <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
                    ...
                    property rights related to it, still belong to ANJALI.</p> <p>ANJALI is committed to ensuring that the app is as useful and efficient as possible. For
                    ...
                    to you exactly what you’re paying for.</p> <p>The Hardi Gurdi app stores and processes personal data that you have provided to us, in order to provide
                    ...
                    the Hardi Gurdi app won’t work properly or at all. </p> <p>You should be aware that there are certain things that ANJALI will not take responsibility
                    for. Certain functions of the app will require the app to have an active internet connection. The connection
                    can be Wi-Fi, or provided by your mobile network provider, but ANJALI cannot take responsibility
                    ...
                    of your data allowance left.
                        ...
                        payer for using the app.</p> <p>Along the same lines, ANJALI cannot always take responsibility for the way you use
                        the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
                        you can’t turn it on to avail the Service, ANJALI cannot accept responsibility.</p> <p>With respect to ANJALI’s responsibility for your use of the app, when you’re using
                        ...
                        it available to you. ANJALI accepts no liability for any loss, direct or indirect,
                        ...
                        app. ANJALI does not promise that it will always update the app so that it is relevant
