...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-dark text-white navbar-laravel">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/home') }}">
                    {{ config('app.name', 'Hardigurdi') }}
                </a>
                ...
                <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{url('/Package')}}">Packages</a>
                            </li> 
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{url('/Question')}}">Question</a>
                            </li> 
