@extends('layouts.app')
 @section('content')
    <div class="container">
        <div class="row">
            <form action="{{url('/notifiction')}}" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea rows="10" required class="form-control" id="msg" name="msg"></textarea>
                  ...
                  <div class="form-inline o">
                    <label for="media" class="m-2">Media</label>
                      ...
                      <div class="form-group m-2">
                        ...
                        <input type="text" name="url" class="from-control"/>                       
                  </div>
                </div>
